---
schema_version: 0
id: "recommendation-alt"
kind: "recommendation"
status: "active"
statement: "Use a second synthetic rehearsal if the checkpoint slips."
details: {"basis":"synthetic-status-review","certainty":"provisional","audience":"shared","baseline":false}
...
sources: [{"type":"recommendation","ref":"source:beacon-alternate-recommendation"}]
...
Use a second synthetic rehearsal if the checkpoint slips.
